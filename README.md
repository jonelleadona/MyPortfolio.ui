# Responisve Portfolio Homework Assignment
...
The working navbar at the top allows the user to click on three different buttoms. Each button will direct the user to different HTML pages based on which button is clicked.
When resizing the page, notice how the content layout will adapt based on the size set.
